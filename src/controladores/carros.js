...
const detalharCarro = async (req, res) => {
    ...
    try {
        const { rowCount, rows } = await pool.query('select * from carros where id = $1', [id])
...
module.exports = { listarCarros, detalharCarro, cadastrarCarro, atualizarCarro, excluirCarro }